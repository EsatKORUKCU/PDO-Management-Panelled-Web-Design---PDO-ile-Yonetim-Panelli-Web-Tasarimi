...
if ($_POST){
    ...
    */
    ...
    $sorgu = $baglan-> prepare("update bolum1 set baslik=?,icerik=?,resim=? where (id=?)");
...
$sorgu = $baglan->query("select * from bolum1")->fetch(PDO::FETCH_ASSOC);
?>
...
<body style = "font-size:18px; text-align:center;">
     ...
     <br><hr><br><br>
     <h2>Bölüm1</h2>
     <form action="bolum1.php" method="post" enctype="multipart/form-data">
